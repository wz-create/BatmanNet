...
from BatmanNet.data.molfeaturegenerator import get_available_features_generators
from BatmanNet.util.utils import makedirs
...
def add_finetune_args(parser: ArgumentParser):
    ...
    parser.add_argument('--data_path', type=str, default="./data/finetune/bbbp.csv",
                        help='Path to data CSV file')
    parser.add_argument('--features_path', type=str, default="./data/finetune/bbbp.npz",
                        help='Path to features to use in FNN (instead of features_generator).')
    parser.add_argument('--save_dir', type=str, default="./model/finetune/bbbp",
                        help='Directory where model checkpoints will be saved')
    parser.add_argument('--checkpoint_path', type=str, default="./pretrained_model/model/model.ep15",
...
def parse_args(parser_name) -> Namespace:
    """
    Parses arguments for training and testing (includes modifying/validating arguments).子

    :return: A Namespace containing the parsed, modified, and validated args.
    """

    parser = ArgumentParser()
    # parser.add_argument('--parser_name', type=str, default=parser_name)
    ...
    args = parser.parse_args([parser_name])
