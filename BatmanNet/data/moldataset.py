...
from BatmanNet.data.molfeaturegenerator import get_features_generator
from BatmanNet.data.scaler import StandardScaler


class MoleculePairDatapoint:
...
class MoleculeProteinDatapoint:
    """A MoleculeDatapoint contains a single molecule and its associated features and targets."""
