...
from BatmanNet.data import MoleculeDataset
from BatmanNet.data import StandardScaler
from BatmanNet.util.utils import get_data, get_data_from_smiles, create_logger, load_args, get_task_names, tqdm, \
...
def predict(model: nn.Module,
    ...
    for _, item in enumerate(mol_loader):
        ...
        with torch.no_grad():
            batch_preds = model(batch, features_batch, output_wise)
            iter_count += 1
            if args.fingerprint:
