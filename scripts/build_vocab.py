...
def build():
    ...
    parser.add_argument('--data_path', default="../exampledata/pretrain/tryout.csv", type=str)
    parser.add_argument('--vocab_save_folder', default="../exampledata/pretrain", type=str)
    parser.add_argument('--dataset_name', type=str, default="tryout",
                        help="Will be the first part of the vocab file name. If it is None,"
                             "the vocab files will be: atom_vocab.pkl and bond_vocab.pkl")
