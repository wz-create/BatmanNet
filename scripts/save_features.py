...
from BatmanNet.util.utils import get_data, makedirs, load_features, save_features
from BatmanNet.data.molfeaturegenerator import get_available_features_generators, get_features_generator


from BatmanNet.data.task_labels import rdkit_functional_group_label_features_generator
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_path', type=str, default='../data/finetune/muv.csv',
                        help='Path to data CSV')
    parser.add_argument('--features_generator', type=str, default='rdkit_2d_normalized',
                        choices=get_available_features_generators(),
                        help='Type of features to generate')
    parser.add_argument('--save_path', type=str, default='../data/finetune/muv.npz',
